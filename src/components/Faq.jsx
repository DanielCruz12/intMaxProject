    ...
    <div>
      <div className="relative w-full overflow-hidden">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/2 px-4 relative overflow-hidden ">
            <div
              className="
                single-faq
                w-full
            ...
            >
              <input
                type="checkbox"
                class="peer w-full h-24 absolute top-0 inset-x-0 z-10 cursor-pointer opacity-0"
              ></input>
              <div className="flex items-center w-full h-2 text-left transition-all duration-500">
                <div
                  className="
                    w-full
                    max-w-[40px]
              ...
              <div className="pl-[62px] transition-all duration-500 hidden peer-checked:block">
                <p className="text-base text-white leading-relaxed py-3 transition-all duration-500">
