  ...
  return (
    <>
      <section className={`${styles.flexCenter} ${styles.paddingY} flex-col `}>
        <div className={`${styles.flexCenter} md:flex-row flex-col mb-8 w-full`}>
          <div className="flex-1 flex flex-col justify-center mr-10">
            ...
            <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
              welcome here to lappsnet network and enjoy about we are doing
            </p>
          </div>
                ...
                <ul>
                  {footerLink.links.map((link, index) => (
                    <li
                      ...
                      } font-poppinns font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer`}
                      key={link.name}
                    >
                      {link.name}
                    </li>
        ...
        <div className="text-gray-400 body-font border-t-[#3F3E45]">
          <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            >
              <span className="ml-3 text-2xl pt-5">Intmax-Wallet</span>
            </a>
